...
const Media = (_a) => {
    var { text, paddingTop, paddingBottom, border = true } = _a, mediaProps = tslib_1.__rest(_a, ["text", "paddingTop", "paddingBottom", "border"]);
    return (react_1.default.createElement(Wrapper_1.Wrapper, { paddings: {
        ...
        react_1.default.createElement("div", { className: border ? b('border') : '', "data-qa": "blog-media-content" },
