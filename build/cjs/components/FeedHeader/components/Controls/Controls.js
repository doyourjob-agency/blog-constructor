    ...
    return (react_1.default.createElement("div", { className: b('header') },
        ...
        react_1.default.createElement("div", { className: b('header-item', { filters: true }) },
            react_1.default.createElement("div", { className: b('filter-item') },
                react_1.default.createElement(Search_1.Search, { className: b('search'), placeholder: (0, i18n_1.i18)(i18n_1.Keyset.Search), initialValue: search && typeof search === 'string' ? search : '', onSubmit: handleSearch, debounce: 0 })),
            react_1.default.createElement("div", { className: b('filter-item') },
